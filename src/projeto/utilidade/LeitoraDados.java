...
import projeto.entidade.Pedido;
import projeto.entidade.Livro;
import projeto.entidade.Caderno;
import projeto.entidade.Produto;
import projeto.entidade.Cupom;
import projeto.entidade.constantes.Genero;
import projeto.entidade.constantes.Materias;
...
public final class LeitoraDados {
	...
	private static Scanner scanner;
	 ...
	 @return Um livro a partir dos dados de entrada*/
		...
		public static Livro lerLivro() {
			...
			System.out.println("Digite o preco(padrao 0.0)");
	 ...
	 * @return Um pedido a partir dos dados de entrada*/
		...
		public static Pedido lerPedido(Banco banco) {
			...
			do {
				...
				System.out.println("Digite o codigo do produto(livro/Caderno)");
				...
				if (resultado.isPresent()) {
					...
					System.out.println("Produto inexistente. Escolha um produto valido");
				}
	 ...
	 * @return O cupom a partir dos dados de entrada*/
		...
		public static Optional<Cupom> lerCupom(Banco banco) {
			...
			System.out.println("Caso queira utilizar algum cupom escolha entre: CUPOM2, CUPOM5, CUPOM7. Se nao desejar, deixe em branco.");
